...
public static class SolidFlagCreator
{
    public static IDistribution<Flag> Dist() =>
        ...
        from charges in FlagChargeCreator.ChargesDist(chargeType, backgroundColours: [colour], size: FlagChargeSize.Large, horizontalLocation: FlagChargeHorizontalLocation.Centre)
